...
public class LicenseActivity extends Activity {
    ...
    private static final String LICENSE_INTRO =
            "FareBot\n"
    ...
    private static final String LICENSE_FELICA =
            "This software contains nfc-felica-lib, an Android library for interfacing with FeliCa smartcards."
    ...
    private static final String LICENSE_AOSP =
            "This software contains portions of the Android Open Source Project\n"
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lblLicenseText.append(LICENSE_FELICA);

        lblLicenseText.append(LICENSE_AOSP);
    }
